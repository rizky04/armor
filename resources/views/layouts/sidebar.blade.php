    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="menu-title">Menu Baru</li>
                <li class="submenu">
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><i class="fa-solid fa-motorcycle"></i><span>
                            Transaksi Motor</span> <span class="menu-arrow"></span></a>
                    <ul>
                        <li>
                ...
                <li class="menu-title">Menu Lama</li>
                @can('menu-client')
                ...
                @can('menu-kendaraan')
                    <li class="{{ request()->routeIs('vehicles.*') ? 'active' : '' }}">
                        <a href="{{ route('vehicles.index') }}"><i class="fa-solid fa-motorcycle"></i><span>
                                Kendaraan Client</span> </a>
                    </li>
                @endcan
                @can('menu-service')
                    <li class="submenu">
                        <a href="javascript:void(0);"><i class="fa-solid fa-warehouse"></i><span>
