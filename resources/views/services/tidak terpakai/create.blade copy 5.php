                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:50px;text-align:center;">
                                            <button type="button" id="add-job" class="btn btn-sm btn-success">+</button>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody></tbody>
                            ...
                            <table class="table table-bordered" id="spareparts-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Total</th>
                                        <th style="width:50px;text-align:center;">
                                            <button type="button" id="add-sparepart" class="btn btn-sm btn-success">+</button>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody></tbody>
        ...
        ajax: {
            ...
            processResults: data => ({
                results: data.map(item => ({
                    id: item.id,
                    text: item.license_plate + ' - ' + item.customer_name
                }))
            })
        }
    });
    ...
    $('#add-sparepart').click(function () {
        $('#spareparts-table tbody').append(`
            <tr>
                ...
                <td>
                    <input type="number" class="form-control price" name="prices[]" value="0">
                </td>
                <td>
