    ...
    <form id="form-service" method="POST">
        ...
        <div class="card p-3 mb-3">
            <div class="row">
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <input type="date" name="due_date" value="{{ \Carbon\Carbon::parse($service->due_date)->format('Y-m-d') }}" class="form-control">
        ...
        <div class="card p-3 mb-3">
            <div class="d-flex justify-content-between mb-2">
                ...
                <button type="button" id="add-jasa" class="btn btn-sm"><i class="fa-regular fa-square-plus" style="color: green"></i></button>
            </div>
                ...
                <tbody>
                    @foreach ($service->jobs as $job)
                        <tr data-key="{{ $loop->index }}">
                            ...
                            <td><button type="button" class="btn btn-sm remove-row"><i class="fa-regular fa-square-minus" style="color: red"></i></button></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
        ...
        <div class="card p-3">
            <div class="row">
                ...
                {{-- Status Pembayaran --}}
    <div class="col-lg-4 col-sm-4 col-12 mt-3">
