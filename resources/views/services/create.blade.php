                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center" style="width:5%; text-align:center;">
                                            <button type="button" id="add-sparepart" class="btn btn-sm btn-primary">
                                                <i class="fa-regular fa-square-plus"></i> Tambah Spearpart
                                            </button>
                                        </th>
                                    </tr>
                                </thead>
...
$('#status_pembayaran').trigger('change');
        ...
        <tr>
            ...
            <td class="text-center"><button type="button" class="btn btn-sm btn-danger remove-row"><i class="fa-solid fa-trash"></i>Hapus</button></td>
        </tr>`;
        ...
        <tr>
            ...
            <td class="text-center"><button type="button" class="btn btn-sm btn-danger remove-row"><i class="fa-solid fa-trash"></i></i>Hapus</button></td>
        </tr>`;
