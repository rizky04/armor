...
<div class="card">
    <div class="card-body">
        ...
        <div class="row mb-2">
            <div class="col-md-12">
                <select id="jasaSelect" style="width:100%;" placeholder="Cari jasa...">
                    <option></option>
                </select>
            </div>
        </div>
...
$(document).ready(function () {
    ...
    function tambahJasa(item) {
        ...
        const tr = $(`
            <tr data-id="${item.id_jasa}" data-kode="${item.kode_jasa ?? ''}" data-nama="${item.nama_jasa}" data-harga="${item.harga}">
